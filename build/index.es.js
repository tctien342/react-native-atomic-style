...
var _a$1 = u(INITIAL_STATES), useGlobalState = _a$1.useGlobalState, getGlobalState = _a$1.getGlobalState; _a$1.setGlobalState;
 ...
 */
var isTablet = function (screenWidth, screenHeight) {
    var pixelDensity = PixelRatio.get();
    var adjustedWidth = screenWidth * pixelDensity;
    var adjustedHeight = screenHeight * pixelDensity;
...
var MAX_DIMENSION = Math.max(SCREEN_WIDTH, SCREEN_HEIGHT);
var SCREEN_RATIO = MIN_DIMENSION / MAX_DIMENSION;
var SCREEN_TYPE = (function () {
    var breakpoint = getGlobalState('EARLY_DEVICE_RATIO_POINT');
    if (isTablet(SCREEN_WIDTH, SCREEN_HEIGHT))
        return 'pad';
    if (SCREEN_RATIO > breakpoint)
        return 'lg';
    return 'sm';
})();

var WIDTH_PERCENT = SCREEN_WIDTH / 100;
var HEIGHT_PERCENT = SCREEN_HEIGHT / 100;
/**
 * Resize an size base on scale value
 * @param size Size that need to be normalize
 */
var reScale = function (size, overrideScale) {
    if (size === 1)
        return 1;
    var baseScale = overrideScale || getGlobalState('SCALE_BASE');
    var newSize = size * baseScale;
    switch (SCREEN_TYPE) {
        case 'sm':
            newSize *= 0.95;
            break;
...
var lodash_1 = lodash.merge;
var lodash_2 = lodash.reduce;

var autoScale = function (obj) {
    return lodash_2(obj, function (res, val, key) {
        res[key] = reScale(val);
        return res;
    }, obj);
};
var FONT_SIZE = autoScale(getGlobalState('FONT_SIZE'));
var SOLID_SIZE = autoScale(getGlobalState('SOLID_SIZE'));
var LIGHT_STYLE = {
    ...
    BORDER: {
        RADIUS: __assign(__assign({}, SOLID_SIZE), { default: reScale(10), pill: reScale(42) }),
    },
    SOLID: SOLID_SIZE,
};
var DARK_STYLE = {
    ...
    BORDER: {
        RADIUS: __assign({ default: reScale(10), pill: reScale(42) }, SOLID_SIZE),
    },
    SOLID: SOLID_SIZE,
};
 ...
 */
var isHexColor = /^#(?:[0-9a-fA-F]{3}){1,2}$/;

var selColor = function (style, select, defaultColor) {
    if (isHexColor.test(select))
        return select;
...
var PositionBuilder = function (style) { return ({
    ...
    z9999: { zIndex: 9999 },
    pa: function (size) {
        if (size === void 0) { size = LIB_DEFAULT.SOLID_SIZE.l1; }
        return ({
            padding: size,
        });
    },
...
var UtilsBuilder = function () { return ({
    img: { maxWidth: '100%' },
    absolute: {
        position: 'absolute',
    },
...
var getStyle = function (dark, token) {
    ...
    var deviceBreakpoint = tokenParts.at(-1);
    ...
    if (builder[token]) {
        ...
        if (tokenPrefix && builder[tokenPrefix]) {
            var buildCmd = builder[tokenPrefix];
            if (typeof buildCmd === 'function') {
                output = buildCmd.apply(void 0, tokenParts);
            }
        }
    }
    return output;
...
var creator = function (isDarkMode) {
    ...
    var prebuilt = function (styleString) {
        ...
        if ((_a = cacheBuilder[styleString]) === null || _a === void 0 ? void 0 : _a[dark]) {
...
var useDarkMode = function () {
    var _a = useGlobalState('THEME_MODE'), mode = _a[0], setMode = _a[1];
    return { isDarkMode: mode === 'dark', setDarkMode: function (isDark) { return setMode(isDark ? 'dark' : 'light'); } };
};
/**
 * Get style base on current phone dark mode status
 */
var useDynamicStyle = function () {
    var isDarkMode = useDarkMode().isDarkMode;
    var _a = useState(isDarkMode ? DARK_STYLE : LIGHT_STYLE), style = _a[0], setStyle = _a[1];
    useEffect(function () {
